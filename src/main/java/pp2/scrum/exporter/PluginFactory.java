    ...
    static {
        ...
        try {
            ...
            propiedades.load(Thread.currentThread().getContextClassLoader()
                    .getResourceAsStream("config/propertiesPluginPackage"));
    ...
    public static List<Exporter> getPlugins() {
        ...
        try {
            ...
            URL resource = ClassLoader.getSystemClassLoader()
                    .getResource(rutaRelPaquete); // ->file:/C:/Users/W7/git/PP2/target/classes/com/ungs/pp2/scrPP2/Plugins
            ...
            if (directorio != null && directorio.exists()) {
                ...
                for (String archivo : archivos)
                    if (archivo.endsWith(".class")) {
                        ...
                        String className = nombrePaquete + '.'
                                + archivo.substring(0, archivo.length() - 6);

                        try {
                            Object objTemp = Class.forName(className)
                                    .newInstance();
                            ...
                            throw new RuntimeException(
                                    "Error al cargar la clase: " + className);
                        }
                    }
            }
            return plugins;
