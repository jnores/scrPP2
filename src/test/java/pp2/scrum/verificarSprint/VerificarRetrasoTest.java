...
public class VerificarRetrasoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        stories.addUserStory(
                new UserStory("Titulo1", "Detalle1", 5, null, tareas1));
        stories.addUserStory(
                new UserStory("Titulo2", "Detalle2", 10, null, tareas2));
        stories.addUserStory(
                new UserStory("Titulo3", "Detalle3", 10, null, tareas3));
        stories.addUserStory(
                new UserStory("Titulo4", "Detalle4", 5, null, tareas4));

        Date inicio = new Date(
                System.currentTimeMillis() - 6 * CalendarioService.DAY);
    ...
    /**
     * Test method for
     * {@link pp2.scrum.verificarSprint.VerificarRetraso#VerificarRetraso(pp2.scrum.dominio.entidad.Sprint)}
     * .
     */
