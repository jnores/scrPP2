...
public class BurndownChartControllerTest extends TestCase {
    ...
    public void testBurndownChartController() {
        // BurndownChartController controller = new
        // BurndownChartController(consultaMock.getMockInstance(),dataComponentMock.getMockInstance());
