...
public class UserStoryComparatorTest extends TestCase {
    ...
    public void testUserStoryHelperComparatorByIdDesc() {
        Collections.sort(stories, UserStoryComparator.decending(UserStoryComparator.NUMERO_SORT ));
        UserStory us;
    ...
    public void testUserStoryHelperComparatorByTituloDesc() {
        Collections.sort(stories, UserStoryComparator.decending(UserStoryComparator.TITULO_SORT) );
        UserStory us;
