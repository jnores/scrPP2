...
public class UserStoryViewTest extends TestCase {
    ...
    protected void setUp() {
        ...
        mailGateway = new EnviadorMail(4444, "127.0.0.1", "pp2mailsender",
                "mail", 0);
        vista = new UserStoryView(new UserStoryHelper(
                new UserStory("user1", "detalle1"), null, Estado.getDefault()));
    }
    ...
    public void testEnviarMailStub() {
        ...
        new ObservadorDeHistoria(controller.getModel(), "mail", mailGateway);
    ...
    public void testEnviarMailRealFallaPassIncorrecto() {
        ...
        // setear controller
        controller.actualizarPaginacion(historias);
        new ObservadorDeHistoria(controller.getModel(), "no-mail@gmail.com",
                mailGateway);
        // Enviar Mail
        controller.finalizarStory(controller.getModel().get(0));
    }
    ...
    public void testEnviarMailRealFallaConectarPuerto() {
        mailGateway = new EnviadorMail(9898, "127.0.0.1", "pp2mailsender",
                "mail", 15);
        controller = new UserStoryPaginadoController();
        // setear controller
        controller.actualizarPaginacion(historias);
    ...
    public void testEnviarMailReal() {
        ...
        // setear controller
        controller.actualizarPaginacion(historias);
        new ObservadorDeHistoria(controller.getModel(),
                "julian.dirisio@gmail.com", mailGateway);
        // Enviar Mail
        controller.finalizarStory(controller.getModel().get(0));
    }
