...
public class LectorTest extends TestCase {
    ...
    String idCommit1 = "id1";
    String idCommit2 = "id2";
    String autor1 = "autor1";
    String autor2 = "autor2";
    ...
    public void testOrdenTexto() {
        assertTrue(RegexFacilities.existeEnElTexto(
                "[cC][oO][Mm][Mm][iI][tT]:*\\s*" + idCommit1, texto));
        assertTrue(RegexFacilities.existeEnElTexto(
                "[cC][oO][Mm][Mm][iI][tT]:*\\s*" + idCommit2, texto));
    }
